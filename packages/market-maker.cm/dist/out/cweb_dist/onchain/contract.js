import { SELF_REGISTER_HANDLER_NAME, addMethodHandler, applyQueue, executeHandler, selfCallWrapper, withContinuations, } from '@coinweb/contract-kit';
import { selfRegisterHandler } from '@coinweb/self-register';
import { PUBLIC_METHODS } from '../offchain/shared/index.js';
import { PRIVATE_METHODS } from './constants.js';
import { cancelOrderPublic, changeContractOwner, changeContractOwnerPublic, changeOrder, changeOrderPublic, closeOrder, createOrder, createOrderPublic, deposit, depositPublic, createRequest, handleExecutionRequestPublic, withdraw, withdrawPublic, handleExecutionBlockTriggered, prepareRequest, } from './methods/index.js';
import { withContractCallLogger } from './utils/index.js';
const addWrappers = (method) => {
...
export const cwebMain = () => {
    ...
    addMethodHandler(module, PRIVATE_METHODS.HANDLE_EXECUTION_BLOCK_TRIGGERED, withContractCallLogger(handleExecutionBlockTriggered));
