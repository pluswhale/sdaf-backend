...
import { FEE, ORDER_ACTIVITY_STATUS, createMakerDepositKey, createOrderCollateralKey, createOrderStateKey, } from '../../../../offchain/shared/index.js';
...
export const cancelOrderPublic = (context) => {
    ...
    const callInfo = {
        ...
        methodInfo: {
            ...
            methodArgs: [id, ORDER_ACTIVITY_STATUS.CANCELLED],
        },
        contractInfo: {
