...
import { REQUEST_EXECUTION_STATUS } from 'market-maker.cm';
import { getAllMarketClaim } from '../api';
const mockedPositions = Array(5)
    .fill(null)
    .map(() => {
    return {
        id: '0xId',
...
export const useMarketMakerOrdersL1AskClaimsPACT = (l1Currency, pubKey, pagination) => {
    const queryKey = ['marketUserOrders', l1Currency, pubKey ?? undefined, pagination];
...
export const useMarketMakerOrdersL1AskClaimsPACTFormatted = (l1Currency, pubKey, pagination) => {
