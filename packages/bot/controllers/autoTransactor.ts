...
export const startAutoTransaction = async (req: Request, res: Response): Promise<any> => {
...
export const stopAutoTransaction = async (req: Request, res: Response): Promise<any> => {
...
export const getAllAutoTransactions = async (req: Request, res: Response): Promise<any> => {
  try {
...
export const dropAllAutoTransactions = async (req: Request, res: Response): Promise<any> => {
  try {
