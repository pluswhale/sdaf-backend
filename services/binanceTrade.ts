...
export async function placeLimitBuyOrder(priceCurrency: number, quantityAmount: number, symbolCurrency: string) { // symbol ex.BNBUSDT
  try {
...
export async function checkOrderStatus(orderId: number, symbol: string) { //symbol ex. BNBUSDT
    try {
