export enum PermissionsEnum {
  ...
  CONTROL_AUTOSEND_DASHBOARD = 'Configure AutoSend at Dashboard',
  CONTROL_AUTOSEND_ARCHIVE = 'Configure AutoSend at Archive',
  CONTROL_AUTOSEND_TEST_DASHBOARD = 'Configure AutoSend at Test',
