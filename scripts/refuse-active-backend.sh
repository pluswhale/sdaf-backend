...
main() {
    if [[ -n $ALLOW_DEPLOY_TO_ACTIVE_BACKEND ]]; then
        echo "WARNING: variable ALLOW_DEPLOY_TO_ACTIVE_BACKEND is set. Check of the active backend will be skipped"
        exit 0
    fi
